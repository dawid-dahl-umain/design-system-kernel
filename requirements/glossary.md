...
- **Build.** Stage 2 of the DSK pipeline: agent reads snapshot plus briefs, produces the library pages.
- **Library page.** One of the web pages DSK causes to be generated for humans (welcome, layouts, examples, content gallery). Lives in `library/` in the company zone. See [outputs.md](outputs.md).
