...
- `dsk:build` — stage 2: read snapshot + briefs, produce **renditions** (web-rendered layouts, examples, and content items reused by compose) plus the **library pages** that browse them.
